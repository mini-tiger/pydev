...
l3 = zip(l1, l2)
# [('D', 'w'), ('P', 'n'), ('T', 'P'), ('Z', 'V'), ('a', 'A'), ('b', 'l'), ('q', 'S'), ('t', 'F')]
print l3
d1 = dict(l3)
# {'Q': 'P', 'E': 'U', 'I': 'v', '1': '2', '5': 'n', 'w': 'S', 'v': 'm', 'Z': 'H'}
print d1

# 排序
d2 = sorted(d1.iteritems(), key=lambda x: x[1])
# [('P', '1'), ('A', 'B'), ('0', 'H'), ('C', 'O'), ('j', 'Q'), ('b', 'R'), ('i', 'i'), ('H', 'm')]
print d2
d3 = dict(d2)
# {'E': 'q', 'j': 'K', 'p': '3', 'r': '8', 'T': 'a', 'W': 'n', '8': 'U', '2': '0'}
print d3

# 追加
# {'a': 3, 'E': '9', 'f': '7', 'm': 'v', '1': 'z', '3': 'F', '5': 'U', 'w': 'J', 'v': 'E'}
d3.update({'a': 3})
print d3
