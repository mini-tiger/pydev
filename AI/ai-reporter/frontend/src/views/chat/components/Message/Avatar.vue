...
import defaultModelAvatar from '@/assets/model.png'
...
<template>
  <template v-if="image">
    <NAvatar class="me" v-if="isString(avatar) && avatar.length > 0" :src="avatar" :fallback-src="defaultAvatar" style="background:#2853E0;">我</NAvatar>
    <NAvatar v-else style="background:#2853E0;">我</NAvatar>
  </template>
  ...
  <NAvatar class="bot" v-else :src="defaultModelAvatar" style="--n-color: rgba(204, 204, 204, 0)" />
  <!-- </span> -->
</template>
